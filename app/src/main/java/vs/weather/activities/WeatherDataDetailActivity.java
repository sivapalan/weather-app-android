...
public class WeatherDataDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weatherdata_detail);
        ...
        if (savedInstanceState == null) {
            ...
            Bundle arguments = new Bundle();
            arguments.putLong(WeatherDataDetailFragment.ARG_ITEM_ID,
                    getIntent().getLongExtra(WeatherDataDetailFragment.ARG_ITEM_ID, -1));
            WeatherDataDetailFragment fragment = new WeatherDataDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.weatherdata_detail_container, fragment)
                    .commit();
        }
    }
